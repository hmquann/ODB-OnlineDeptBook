...
public class TransactionDAO extends DBContext {
    ...
    public String insertNewDebt(String note, String money, boolean classify, String dateDebt, int customerID, int CreateBy) {
        ...
        try {
            ...
            System.out.println("insertDebt error " + e.getMessage());
        }
        return null;
    }
